    ...
    public function storeFormation_administrateur(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('video_formation')) {
                ...
                $request->merge(['video_formation' => 'storage/videos/'.$name]); // Assurez-vous que ce chemin est stocké
            }

            // Pour la création dans l'ensemble des données
            
            Formation::create([
                'nom_formation' => $request->nom_formation,
                'matricule' => $request->matricule,
                'video_formation' => $request->video_formation ?? null,
                'description_formation' => $request->description_formation,
